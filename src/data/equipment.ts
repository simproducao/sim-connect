...
export const EQUIPMENT: EquipmentDef[] = [
  ...
  },
  {
    ...
    quantity: 1,
    ports: [
      { id: 'lc-in-1', label: 'LC/LC IN 1', direction: 'input', signalType: 'FIBER' },
      { id: 'lc-in-2', label: 'LC/LC IN 2', direction: 'input', signalType: 'FIBER' },
      { id: 'lc-in-3', label: 'LC/LC IN 3', direction: 'input', signalType: 'FIBER' },
      { id: 'lc-in-4', label: 'LC/LC IN 4', direction: 'input', signalType: 'FIBER' },
      { id: 'lc-in-5', label: 'LC/LC IN 5', direction: 'input', signalType: 'FIBER' },
      { id: 'lc-in-6', label: 'LC/LC IN 6', direction: 'input', signalType: 'FIBER' },
      { id: 'lc-out-1', label: 'LC/LC OUT 1', direction: 'output', signalType: 'FIBER' },
      { id: 'lc-out-2', label: 'LC/LC OUT 2', direction: 'output', signalType: 'FIBER' },
      { id: 'lc-out-3', label: 'LC/LC OUT 3', direction: 'output', signalType: 'FIBER' },
      { id: 'lc-out-4', label: 'LC/LC OUT 4', direction: 'output', signalType: 'FIBER' },
      { id: 'lc-out-5', label: 'LC/LC OUT 5', direction: 'output', signalType: 'FIBER' },
      { id: 'lc-out-6', label: 'LC/LC OUT 6', direction: 'output', signalType: 'FIBER' },
      { id: 'rede-1', label: 'REDE IN/OUT 1', direction: 'input', signalType: 'ETHERNET' },
      { id: 'rede-2', label: 'REDE IN/OUT 2', direction: 'input', signalType: 'ETHERNET' },
      { id: 'rede-3', label: 'REDE IN/OUT 3', direction: 'input', signalType: 'ETHERNET' },
      { id: 'rede-4', label: 'REDE IN/OUT 4', direction: 'input', signalType: 'ETHERNET' },
      { id: 'rede-5', label: 'REDE IN/OUT 5', direction: 'input', signalType: 'ETHERNET' },
      { id: 'sdi-in-1', label: 'SDI IN 1', direction: 'input', signalType: 'SDI' },
      { id: 'sdi-in-2', label: 'SDI IN 2', direction: 'input', signalType: 'SDI' },
      { id: 'sdi-in-3', label: 'SDI IN 3', direction: 'input', signalType: 'SDI' },
      { id: 'sdi-in-4', label: 'SDI IN 4', direction: 'input', signalType: 'SDI' },
